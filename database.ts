...
// const databaseDirectory = path.resolve(__dirname, 'out');
...
//         table.bigInteger("Number of employees"); // Change 'numEmployees' to 'employees'
//     });
// }

// // Call initializeDatabase function to start the database setup process
// initializeDatabase();
